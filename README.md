# Code Explaination
This is a simplified explaination to the first practical of cloud computing, which involves spliting a c program into multiple modules and then executing it. The program present in the *firstprac* folder is the exact implementation as mentioned in the lab manual 
